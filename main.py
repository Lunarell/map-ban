...
attack_ops = ["no","Ace", "Amaru", "Ash", "Blackbeard", "Blitz", "Buck", "Capitao", "Dokkaebi", "Finka", "Flores", "Glaze", "Gridlock", "Hibana", "Iana", "IQ", "Jackal", "Kali", "Lion", "Maverick", "Montagne", "Nokk", "Nomad", "Osa", "Sens", "Sledge", "Thatcher", "Thermite", "Twitch", "Ying", "Zero", "Zofia", "Grim", "Brave", "Fuze", "Ram", "Demos", "Rauora"]
defense_ops = ["no","Alibi", "Aruni", "Azami", "Bandit", "Castle", "Caveira", "Clash", "Doc", "Echo", "Ela", "Frost", "Goyo", "Jäger", "Kaid", "Kapkan", "Lesion", "Melusi", "Mira", "Mozzie", "Mute", "Orxy", "Pulse", "Rook", "Smoke", "Tachanka", "Thorne", "Thunderbird", "Valkyrie", "Vigil", "Wamai", "Warden", "solis", "Maestro", "Fenrir", "Tubarao", "Skopos"]
